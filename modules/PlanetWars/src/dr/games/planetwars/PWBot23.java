...
public class PWBot23 implements PWBot {
    ...
    //////////////////
    // dr.games.planetwars.Planet lists //
    //////////////////
    ...
    // Returns a mapping from a dr.games.planetwars.Planet ID to a list of possible moves
...
//        // Copy the game state
//        dr.games.planetwars.PWGameState newPWGameState = new dr.games.planetwars.PWGameState(gameState);
//
//        // List used to add orders during the simulations. Must be cleared.
//        List<dr.games.planetwars.PWOrder> playOrders = new ArrayList<dr.games.planetwars.PWOrder>();
//
//        // A mapping from a dr.games.planetwars.Planet ID to a list of possible moves
//        Map<Integer, List<dr.games.planetwars.PWMiniMove>> planetAllMoves = planetAllMoves(newPWGameState);
//
//        // A mapping of the moves to the score
//        Map<dr.games.planetwars.PWMiniMove, Double> moveResults = new HashMap<dr.games.planetwars.PWMiniMove, Double>();
//
//        // Run 100 simulations
//        for (int i = 0; i < 100; i++)
//        {
//            // Mapping of the move performed for a given move
//            Map<dr.games.planetwars.PWMiniMove, Integer> mv = new HashMap<dr.games.planetwars.PWMiniMove, Integer>();
//
//            // Make the first moves
//            for (Map.Entry<Integer, List<dr.games.planetwars.PWMiniMove>> entry : planetAllMoves.entrySet()) {
//                // Pick a random move from the available moves
//                int ix = entry.getValue().size();
//                int randomMoveIndex = rand.nextInt(ix);
//                dr.games.planetwars.PWMiniMove randomMove = entry.getValue().get(randomMoveIndex);
...
//                dr.games.planetwars.PWOrder order = new dr.games.planetwars.PWOrder(playerID, srcPlanetID, dstPlanetID, numShips);
...
//            {
//                Map<Integer, List<dr.games.planetwars.PWMiniMove>> pmoves = planetAllMoves(newPWGameState);
//
//                for (Map.Entry<Integer, List<dr.games.planetwars.PWMiniMove>> entry : pmoves.entrySet()) {
//                    // Pick a random move from the available moves
...
//
//            // Update the values
//            for (dr.games.planetwars.PWMiniMove miniMove : mv.keySet()) {
//                double prevValue = 0;
...
//            dr.games.planetwars.PWMiniMove bestMove = null;
//            for (dr.games.planetwars.PWMiniMove move : entry.getValue()) {
//                // TODO: temp fix
