...
public class PWBotDR implements PWBot {
    ...
    // dr.games.planetwars.Planet comparators
...
//    private static final dr.games.planetwars.PWPlanetSortByDistance PLANETS_SORT_BY_DIST_DESC =
//            (dr.games.planetwars.PWPlanetSortByDistance) Collections.reverseOrder(new dr.games.planetwars.PWPlanetSortByDistance());
    ...
    // dr.games.planetwars.Fleet comparators
//    private static final Comparator<dr.games.planetwars.PWFleet> FLEETS_SORT_BY_NUM_SHIPS = new dr.games.planetwars.PWFleetSortByNumShips();
//    private static final Comparator<dr.games.planetwars.PWFleet> FLEETS_SORT_BY_TURNS_REMAINING = new dr.games.planetwars.PWFleetSortByTurnsRemaining();
...
//                for (dr.games.planetwars.PWPlanet neighbor : myNeighbors) {
//                    if (neighbor.getOwner() == playerID) {
//                        if (myPlanet.getGrowthRate() < neighbor.getGrowthRate()) {
//                            if (myPlanet.getNumShips() > 1) {
//                                orders.add(new dr.games.planetwars.PWOrder(playerID, myPlanet.getPlanetID(), neighbor.getPlanetID(),
...
//            System.out.println("dr.games.planetwars.Planet dist: "+ gameState.distance(strongestPlanet.getPlanetID(),
//                    planet.getPlanetID()));
...
//    private dr.games.planetwars.PWPlanet myPlanetWithMostShips()
//    {
//        dr.games.planetwars.PWPlanet planet = null;
//        double score = Double.MIN_VALUE;
//
//        for (dr.games.planetwars.PWPlanet p : gameState.myPlanets(playerID))
//        {
