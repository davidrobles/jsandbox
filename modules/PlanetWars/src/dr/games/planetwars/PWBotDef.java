...
//        initData();
//
//        dr.games.planetwars.PWPlanet nearestPlanet = nearestFromAll();
//
...
//        }
//
//        Map<dr.games.planetwars.PWPlanet, Integer> myAttackingPlanets = fightPlanetFromMyAllPlanets(nearestPlanet);
//
//        for (Map.Entry<dr.games.planetwars.PWPlanet, Integer> entry : myAttackingPlanets.entrySet()) {
//            orders.add(new dr.games.planetwars.PWOrder(playerID, entry.getKey().getPlanetID(), nearestPlanet.getPlanetID(), entry.getValue()));
//        }
...
//            // Get the best planet
//            for (dr.games.planetwars.PWPlanet planet : allPlanets) {
...
//            dr.games.planetwars.PWPlanet strongestPlanet = myPlanets.get(0);
//            Collections.sort(allPlanets, PLANETS_SORT_BY_NUM_SHIPS_ASC);
//            int shipsAllocated = 0;
//
//            for (dr.games.planetwars.PWPlanet dstPlanet : allPlanets) {
...
//                        }
//                        orders.add(new dr.games.planetwars.PWOrder(playerID, strongestPlanet.getPlanetID(), dstPlanet.getPlanetID(),
//                                shipsToNeighbor));
...
//            for (dr.games.planetwars.PWPlanet myPlanet : myPlanets) {
//                if (myPlanet != bestPlanet) {
//                    orders.add(new dr.games.planetwars.PWOrder(playerID, myPlanet.getPlanetID(), bestPlanet.getPlanetID(),
...
//        orders.add(new dr.games.planetwars.PWOrder(playerID, strongestPlanet.getPlanetID(), worst.getPlanetID(),
//                strongestPlanet.getNumShips() / 2));

        // 2. get nearest planet
//            int bestScore = Integer.MAX_VALUE;
//            dr.games.planetwars.PWPlanet nearestPlanet = null;
//            myPlanets = gameState.myPlanets(playerID);
//            for (dr.games.planetwars.PWPlanet myPlanet : myPlanets) {
//                for (dr.games.planetwars.PWPlanet otherPlanet : gameState.getAllPlanets()) {
...
//            }
//            if (nearestPlanet != null) {
//                orders.add(new dr.games.planetwars.PWOrder(playerID, strongestPlanet.getPlanetID(), nearestPlanet.getPlanetID(),
//                        strongestPlanet.getNumShips() / 2));
//            }
...
//        {
//            for (dr.games.planetwars.PWPlanet srcPlanet : gameState.myPlanets(playerID))
//            {
//                List<dr.games.planetwars.PWPlanet> allPlanets = gameState.getAllPlanets();
//                Collections.sort(allPlanets, PLANETS_SORT_BY_NUM_SHIPS_ASC);
//                int shipsAllocated = 0;
//
//                for (dr.games.planetwars.PWPlanet dstPlanet : allPlanets)
...
//                            shipsToNeighbor = dstPlanet.getNumShips() + 1;
//                            orders.add(new dr.games.planetwars.PWOrder(playerID, srcPlanet.getPlanetID(), dstPlanet.getPlanetID(),
//                                    shipsToNeighbor));
//                            shipsAllocated += shipsToNeighbor;
