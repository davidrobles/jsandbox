...
import dr.gridworld.view.GWVView;
import dr.gridworld.view.GWViewQValues;
import dr.rl.algorithms.TabularSARSA;
import dr.rl.algorithms.TabularSARSALambda;
import dr.rl.algorithms.TabularTD0;
import dr.rl.policies.EpsilonGreedy;
import dr.rl.policies.RLPolicy;
import dr.rl.policies.RandomPolicy;
import dr.util.DRFrame;
...
//    }
    ...
    private static void TabularTD0()
    {
        ...
        TabularTD0<GWState, GWAction> learner = new TabularTD0<>(env, policy, alpha, gamma, numEpisodes);
        learner.addVFunctionObserver(view);
        learner.learn();
    }
...
//    }
    ...
    private static void TabularSARSA0()
    {
        ...
        TabularSARSA<GWState, GWAction> learner = new TabularSARSA<>(env, policy, alpha, gamma, numEpisodes);
