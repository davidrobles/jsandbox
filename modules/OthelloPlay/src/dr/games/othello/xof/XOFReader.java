 ...
 * format used into OthBase as the primary supported file format for games databases.
 */
public class XOFReader
{
    ...
    {
//        checkGames(loadGames("OthelloSB/resources/games/woc2006.txt"));
