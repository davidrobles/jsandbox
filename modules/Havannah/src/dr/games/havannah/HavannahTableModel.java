...
public class HavannahTableModel implements TableModel
{
    private static final String[] columnNames = {"Turn", "Black", "White"};
    private MatchController<Havannah> controller;

    public HavannahTableModel(MatchController<Havannah> controller)
    {
