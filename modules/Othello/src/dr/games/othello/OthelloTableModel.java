...
public class OthelloTableModel implements TableModel
{
    private static final String[] columnNames = {"Turn", "Black", "White"};
    private MatchController<Othello> controller;

    public OthelloTableModel(MatchController<Othello> controller)
    {
